    ...
    public partial class EditImagePage : ContentPage
    {
        ...
        private async Task ProcessImageEdit(string prompt)
        {
            try
            {
                ...
                // HACK: Do not ever use a direct file path that only works on YOUR SYSTEM! Other people working on this project will receive an error.
                // The way this is implemeted makes most features not work on images generated by this app.
